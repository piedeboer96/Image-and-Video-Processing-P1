...
# RGB image 1
fig.add_subplot(rows, columns, 1); plt.imshow(r1, cmap='gray'); plt.axis('off'); plt.title("Red Channel Image 1")
fig.add_subplot(rows, columns, 2); plt.imshow(g1, cmap='gray'); plt.axis('off'); plt.title("Green Channel Image 1")
fig.add_subplot(rows, columns, 3); plt.imshow(b1, cmap='gray'); plt.axis('off'); plt.title("Blue Channel Image 1")
...
# RGB image 2
fig.add_subplot(rows, columns, 1); plt.imshow(r2, cmap='gray'); plt.axis('off'); plt.title("Red Channel (Image 2)")
fig.add_subplot(rows, columns, 2); plt.imshow(g2, cmap='gray'); plt.axis('off'); plt.title("Green Channel (Image 2)")
